...
class KinectPointCloudNode(Node):
    def __init__(self):
        ...
        self.point_cloud_publisher = self.create_publisher(PointCloud2, 'accumulated_point_cloud', 10)

        # Crear un broadcaster de tf
        self.tf_broadcaster = tf2_ros.TransformBroadcaster(self)

        # Almacena la nube de puntos acumulativa
    ...
    def publish_filtered_point_cloud(self):
        ...
        for y in range(height):
            for x in range(width):
                ...
                points.append([point_3d_m[0], point_3d_m[1], point_3d_m[2]])

        # Agregar puntos a la nube acumulativa
        ...
        header.frame_id = 'world'  # Publicamos la nube de puntos en el frame 'world'
        ...
        cloud_msg.height = 1
        cloud_msg.width = len(self.accumulated_points)
        ...
        self.get_logger().info(f"Nube de puntos acumulada publicada con {len(self.accumulated_points)} puntos.")
